...
in {
  ...
  biome = mkBinaryRelease rec {
    ...
    version = "2.5.11";
    hashes = {
      "aarch64-darwin" = "sha256-egZ7AP347u+39fXyR7fawbsjrf6uo4CpEpM1O44uuis=";
      "aarch64-linux" = "sha256-seQixM9d54hVP2ErOVLerdbLdmmzVlkZevFMSx92P6s=";
      "x86_64-linux" = "sha256-Yppy0w5bYltwcjplHFEMDC1K3HybczSmkK/oSLpEJs4=";
    };
    platformMap = {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    hashSource = "manifest";
    hashes = {
      "aarch64-darwin" = "sha256-iEuqOP4aYkviXEqRVov1oItc9OfXrPKbd2DjUl2WSJg=";
      "x86_64-darwin" = "sha256-r4dBz/DT+1xLiTx8s2E70hso+mHMpFRp1guOXhYeudg=";
      "aarch64-linux" = "sha256-xv8Dw4nM3q4PGencMkiO66YfvvR5b1Mdv7psAPRQQNA=";
      "x86_64-linux" = "sha256-991irkFTeAGM0h3ZUOs7rBdKsIWDAwTTuLCYFGv9R7Y=";
    };
    platformMap = {
      "aarch64-darwin" = "darwin-arm64";
