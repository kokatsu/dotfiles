...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.158";
    hashes = {
      "aarch64-darwin" = "sha256-EPOYUQ8Oa9fGd+4lz8aYYBv4seyJZY+CP6I6L4Copz8=";
      "x86_64-darwin" = "sha256-M7DmDkA1EhDxu7NqlHjOElR0GEzgtocfaF9Yfwvhspo=";
      "aarch64-linux" = "sha256-VyIzZcvhZUb7TA4okSs/jLYcrCtczKhLcXGdnxMyhr8=";
      "x86_64-linux" = "sha256-MhVQH4z+6acGAcL7wshOnQIOTnFIoLi4Jk9NjAJrxks=";
    };
    platformMap = {
