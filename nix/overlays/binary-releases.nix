...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.79";
    hashes = {
      "aarch64-darwin" = "sha256-Ckk582vAGUAhxW+lyEcK2E4igvL0BPFZipQMIEQRcWg=";
      "x86_64-darwin" = "sha256-FNkZOoWmsZGwkP0qHOJhkFzM8L9nKCOdfCFHcZZBljw=";
      "aarch64-linux" = "sha256-dc+HRlGXiD32Hcuxh9StP8Axv5GSdlgVmSnc0pWVQtw=";
      "x86_64-linux" = "sha256-sSCkE5pEd6JxmusLLHkKXC/i2QTkf04q3zyrM7NC0Do=";
    };
    platformMap = {
