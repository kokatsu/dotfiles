...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.165";
    hashes = {
      "aarch64-darwin" = "sha256-x1gukm6P5Fnb2XQ/Gcy3VQDjtFXHIpAtGqWHp0+x+nw=";
      "x86_64-darwin" = "sha256-pAn8YMzWeJ9HUyeR7SPKBId0z70LChb59X27+SQP2nw=";
      "aarch64-linux" = "sha256-ygAQqA48R0nlnG6EKexKTi7LqvrDbTU1Y24ENpu7h8A=";
      "x86_64-linux" = "sha256-Xd3LLAkdpgz5sb73gubHin+tovLNPbTxMcnrwkeP1Ec=";
    };
    platformMap = {
