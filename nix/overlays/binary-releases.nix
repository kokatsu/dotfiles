...
in {
  ...
  mise = mkBinaryRelease rec {
    ...
    version = "2026.9.3";
    hashes = {
      "aarch64-darwin" = "sha256-lWDt90puXpfz2WemN8ELvhdsJniX3YAR8JsWqPKKldI=";
      "aarch64-linux" = "sha256-cxCm5PbD/sigdtkcj/9L7hzACaQhO949rojhTQd7dho=";
      "x86_64-linux" = "sha256-NbCD8ySfoU5GD3Z9WKUMtfA6iF98FPay4l2OgAUKCiU=";
    };
    platformMap = {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    hashSource = "manifest";
    hashes = {
      "aarch64-darwin" = "sha256-GV4k6OH5v0bx6u5y1DSjPhj59XlvKaY0igDRbF+K7nU=";
      "aarch64-linux" = "sha256-IUqQ790W7g6oETL/7M7ViNujlNF4zElPKFugS1KIyN4=";
      "x86_64-linux" = "sha256-2BOWpmjrdvvdtJoqWEHxtdevlrTB9lAM7ZLyyYj1vNQ=";
    };
    platformMap = {
