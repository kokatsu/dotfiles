...
in {
  ...
  mise = mkBinaryRelease rec {
    ...
    version = "2026.9.1";
    hashes = {
      "aarch64-darwin" = "sha256-PPvjKV26Gn5DvQJlNReozCETW6kfBjW0XJjx6+zFUT8=";
      "aarch64-linux" = "sha256-AXW70Fg5EFqZ3JWZwDF2VOjwHmfADS05TtUellvaKlE=";
      "x86_64-linux" = "sha256-+1ERo+Rjibz8AmYy5dwM/dRbZWUUbCG9ucenXM77wZM=";
    };
    platformMap = {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    hashSource = "manifest";
    hashes = {
      "aarch64-darwin" = "sha256-VT0bnp5waLJ1wKeDx+E5/2UDCW8obmdMjJGTefsOymI=";
      "aarch64-linux" = "sha256-bkTF08l++qHuNauN2HWpB2gXB+XMT2yg2j0TqRe7zts=";
      "x86_64-linux" = "sha256-GYQnBemJOT/Ok2gE320qsDSGDiS4+IgDV5gdh//YP6w=";
    };
    platformMap = {
