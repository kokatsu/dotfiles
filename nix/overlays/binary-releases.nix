...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.191";
    hashes = {
      "aarch64-darwin" = "sha256-mf37VSpSYOZJrt0GwCTQpBBbCc7+wL9n1VjgF+5mxAA=";
      "x86_64-darwin" = "sha256-boOq1fxP1Fn9dFOc2gbSJ5EF6sK+/GA9L7pklJdMsqQ=";
      "aarch64-linux" = "sha256-GjGny8/XhPjAc7/IoKFYP7bpPmDvcLdtf89mP/7YlJs=";
      "x86_64-linux" = "sha256-EDjbqIvfG4CUHcPjg+k7CIMlsASXMprFDaRgyHhtW+4=";
    };
    platformMap = {
      "aarch64-darwin" = "darwin-arm64";
