...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.90";
    hashes = {
      "aarch64-darwin" = "sha256-c8GnVwUBynQ80tdGfLRpkQNTSiE4BSpObKtTwOCdecg=";
      "x86_64-darwin" = "sha256-mTRnUGPqQ2BmW3pD9knJLmulz5MlcySvevGmtJB0Y5U=";
      "aarch64-linux" = "sha256-FdUInufZmB+qz1Rj6r1CegEoFNn8AhE4g7sjpPOHrUo=";
      "x86_64-linux" = "sha256-YHTjlZmJspWKmr7GCt97RBoPbxx+ZkAav/D+VNrQT9Y=";
    };
    platformMap = {
