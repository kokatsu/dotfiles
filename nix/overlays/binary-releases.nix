...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    hashSource = "manifest";
    hashes = {
      "aarch64-darwin" = "sha256-qSKYH287VaJR75+duqBiGl+Zy8tcpn+KeXR2zPyD9iY=";
      "aarch64-linux" = "sha256-3SezZDik/tFnDNKbrS/aanO2KLbaVUQ+XC9kf+btMo8=";
      "x86_64-linux" = "sha256-Vv49qIRYRl+yfX6Smd3bP+rVV1D7nC3nlfIzte6m3OE=";
    };
    platformMap = {
  ...
  dcd = mkBinaryRelease rec {
    ...
    version = "0.19.3";
    hashes = {
      "aarch64-darwin" = "sha256-uwXSe6xFhXOvrY6lkq7RTl4/eJlAJVwRWJiz0jepbLs=";
      "aarch64-linux" = "sha256-x1WkD7ZzCmdh5f2iIT+WLpfIj0cROrXSFvC2at4btDI=";
      "x86_64-linux" = "sha256-uKP6Vkt+EPZwDTZJCbRXqlf84FETVQO0bB7NRayO+ec=";
    };
    platformMap = {
