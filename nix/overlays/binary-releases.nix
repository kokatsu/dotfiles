...
in {
  ...
  mise = mkBinaryRelease rec {
    ...
    version = "2026.7.6";
    hashes = {
      "aarch64-darwin" = "sha256-5e2431weSrmazkhphxYUtHYX4bsxQjnXPXLn+auoiRU=";
      "aarch64-linux" = "sha256-s2TzBy9K1jJ1jx8lLk/vjXWFj5di2iVRa4CLwR/vPAo=";
      "x86_64-linux" = "sha256-eLMz4cNIiNHquHLUGSfDXQxKeR/lzntHoxR9y0CFySU=";
    };
    platformMap = {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    hashSource = "manifest";
    hashes = {
      "aarch64-darwin" = "sha256-WEDHd/1HEV6conbhZVY8bhIefH4rTYZZjgAl+Mw33lY=";
      "x86_64-darwin" = "sha256-g4em/UTt/UDX50xf3DJwoV9eaxtYx8b+5WDnDT0ZQ9o=";
      "aarch64-linux" = "sha256-QMU1B6xmnB1Dg2bBl2DCL1J0igblDg/A41PSy3NCVZc=";
      "x86_64-linux" = "sha256-JjD8XcbbYbwD+GuV2vR3ZuXtW2GHP3u3z+p2TFrFqbo=";
    };
    platformMap = {
      "aarch64-darwin" = "darwin-arm64";
  ...
  codex = mkBinaryRelease rec {
    ...
    hashes = {
      "aarch64-darwin" = "sha256-7Ok3Fp1MnpENYIJqbqSueEihbAiUA9Ei5w59pKxBujQ=";
      "x86_64-darwin" = "sha256-nUAsnKgUZV/dwHtUjXCGSRwK/Ovh90bN66EEX9b2JkY=";
      "aarch64-linux" = "sha256-VPeaBaum+av475iKvK6L8vzvuiC+tUm0/ys6zbLLb1Q=";
      "x86_64-linux" = "sha256-caKNNiyWrJgpv4IDoscb5FGutyatuEMWf9rw6uj+fdk=";
    };
    platformMap = {
      "aarch64-darwin" = "aarch64-apple-darwin";
      "x86_64-darwin" = "x86_64-apple-darwin";
