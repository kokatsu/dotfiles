...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.139";
    hashes = {
      "aarch64-darwin" = "sha256-qooKOfKrvZ4JUY63JozaEFuAKWIKOPWly8NitlMxw9s=";
      "x86_64-darwin" = "sha256-EjA9A4FOdujQn7mJKG6It8WGX6zQDXG8eQES2uCHrO8=";
      "aarch64-linux" = "sha256-OYWq91s7/x2NAxtybIBOQVLhUwJhaDzc4U6VTwryyRI=";
      "x86_64-linux" = "sha256-wYAKCuUbWkx7M75qMtYrYWnZP2F0EZsu62iWzwzV1+Y=";
    };
    platformMap = {
