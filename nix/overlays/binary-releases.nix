...
in {
  ...
  mise = mkBinaryRelease rec {
    ...
    version = "2026.8.14";
    hashes = {
      "aarch64-darwin" = "sha256-upOz/n5Hlk5DktQMi3v6V0DowqCldePoYmjpdkCC7T4=";
      "aarch64-linux" = "sha256-SuFNcxn88Bqo1itTuOdGNthZfAR5K1/ebNDmQB12q60=";
      "x86_64-linux" = "sha256-0YZOxRNyebsEq8iRS583sDutqtex2D0eHc2L674zwLI=";
    };
    platformMap = {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    hashSource = "manifest";
    hashes = {
      "aarch64-darwin" = "sha256-tjE2GUFgeRwnz6ewQDBg2F6wdSmRYl/ejAn5rKyxfHg=";
      "x86_64-darwin" = "sha256-yFfbXNcShlYjvWHoBs8/fo4nnJ5cfAr17KBspnF/x/s=";
      "aarch64-linux" = "sha256-Q9xJCvVSYu3LPpscsxXeIswJzLCL1SpMObxeq6pjEA8=";
      "x86_64-linux" = "sha256-cE8TNKxl0+ieHGwddmMpOteGphZq/bcbUHUzffYw+XY=";
    };
    platformMap = {
      "aarch64-darwin" = "darwin-arm64";
