...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.83";
    hashes = {
      "aarch64-darwin" = "sha256-QyRqn/Id4nxRf0ivUsnVEMnm5wvZCxFdgLnGkMUVrg0=";
      "x86_64-darwin" = "sha256-vRbu/F97o9G3keMR9NWySsMXRYgRCjjbHIjBtR3IghQ=";
      "aarch64-linux" = "sha256-ZgvduCwGppvvjkaP+43SNUISu3beEi/l1nOTVkuTLek=";
      "x86_64-linux" = "sha256-/3nNXRUgFzJvZhMJu/++/JVPAqGV+yMq2hUtgS5HbmY=";
    };
    platformMap = {
