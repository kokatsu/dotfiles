...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.78";
    hashes = {
      "aarch64-darwin" = "sha256-ZCZ3JBnHWOcRRnJVgtZ/HdpCaHxpPIPe+a00IruB6/E=";
      "x86_64-darwin" = "sha256-m+SiSiE80/R1cT6Pt1SMYxqr3DVcoZHpJsy2PxKXZAk=";
      "aarch64-linux" = "sha256-9DA6GjRVsOu901bBM3rjB2r/wSL7eaeKLRiG5cYvKJw=";
      "x86_64-linux" = "sha256-NFWcnMnurclC1nMTZ67TkVtrc1HZjGHr/rvY+llQjs0=";
    };
    platformMap = {
