...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.168";
    hashes = {
      "aarch64-darwin" = "sha256-N38OztuoJGvavfMSzot8yK4RYJl7JvXtyjUqSo1h3Hg=";
      "x86_64-darwin" = "sha256-aI89n6CVWHjCkaWP6+nk2qBhMm2iF62nQNl8XhdjSiY=";
      "aarch64-linux" = "sha256-QNUOfEV0Kqo3B/o2KNf3ZcVe1QMQi28QBRPjjTJHeqA=";
      "x86_64-linux" = "sha256-4vfLUEQr3uIb8mhu83JaavGHogTkbEr1wS0PbXYyZIU=";
    };
    platformMap = {
