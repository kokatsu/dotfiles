...
in {
  ...
  biome = mkBinaryRelease rec {
    ...
    hashes = {
      ...
      "x86_64-linux" = "sha256-598pjwVR3ZC+pEJXeTaaoxMNmBf0rMT2Y+9jwycgahk=";
    };
    platformMap = {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    hashSource = "manifest";
    hashes = {
      "aarch64-darwin" = "sha256-b8bmGrdYLCvyQSJf+Q2feekdaTgMuVifyd7dOjAHD1o=";
      "x86_64-darwin" = "sha256-MsdNZuJ7nKd66mOPxGyxHJBHC9DSlLKpgQZdqIltHuA=";
      "aarch64-linux" = "sha256-BaqRidM10ekhypYIrNaZGT5mFVmv9WcERWzlvab9Tdg=";
      "x86_64-linux" = "sha256-65M8bdVTTbibg7oJAJ1cCTK9E5X347sPNLo37sN7ut4=";
    };
    platformMap = {
      "aarch64-darwin" = "darwin-arm64";
  ...
  codex = mkBinaryRelease rec {
    ...
    hashes = {
      "aarch64-darwin" = "sha256-j4HNnQ7BCLEiAFUDjuAuFLm7xGUaUDZ1MS1FPnIn2CY=";
      "x86_64-darwin" = "sha256-enbDvi7VE5wJnbyr0zFmI8EvXyio+yALRm37mUob3T4=";
      "aarch64-linux" = "sha256-D6R8SZ4xDdDxs876nm96Xo6YxO0ChdexNISiACNtRlI=";
      "x86_64-linux" = "sha256-edBJQnUUqSmOd76SrZu7dKNGtQ+mWYUfgH2nNj2hHL0=";
    };
    platformMap = {
      "aarch64-darwin" = "aarch64-apple-darwin";
      "x86_64-darwin" = "x86_64-apple-darwin";
  ...
  kakehashi = mkBinaryRelease rec {
    ...
    version = "0.6.0";
    hashes = {
      "aarch64-darwin" = "sha256-TBYLPSxG091PsX5KaO3C9Br9rxZ3BAnsi6mLRcYu8mo=";
      "x86_64-darwin" = "sha256-ev9BnfkJIhssO/uF4WQR7MtsC7D6JdeYb2IL0IcQGw4=";
      "aarch64-linux" = "sha256-zyPXAsr/wiK++LXghEsCSQmqN/QMUXauIajxP1NVxG8=";
      "x86_64-linux" = "sha256-EXEAEbizAURTUf7Ve4Ke/EgOJqmalJcjqhODsU9/ekg=";
    };
