...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.170";
    hashes = {
      "aarch64-darwin" = "sha256-hti4IK1+7VDlChMHBtPcXvcGlvkRlN4bOJeoQhgq/jo=";
      "x86_64-darwin" = "sha256-bY1RDHFbiZMHt9KaEGLUPmLJk3DFUzDaw+wYUaL798g=";
      "aarch64-linux" = "sha256-NBByOVhEsrbShG2NYdVRdSsSpEQzySDQzH/m57VpKps=";
      "x86_64-linux" = "sha256-zwZr82DL97UavrjLIwAS/A8v7UJTss4wXeSMzW1Jo5w=";
    };
    platformMap = {
