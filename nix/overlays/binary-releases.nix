...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    hashSource = "manifest";
    hashes = {
      "aarch64-darwin" = "sha256-pQa22XCkz0T2q9tTqB3c1dOwzgQqlcUC/p0flGvbiAc=";
      "aarch64-linux" = "sha256-e/nzOswSTfmrzPbyNmOXqCp0A3jVNfoS1Cb6d/28mUY=";
      "x86_64-linux" = "sha256-OmJKWnzXm7rU0yvX2zbxGX7PRYvFvx4q7YGDSgGtPvA=";
    };
    platformMap = {
  ...
  dcd = mkBinaryRelease rec {
    ...
    version = "0.18.2";
    hashes = {
      "aarch64-darwin" = "sha256-uYQl9JXZAhykHY3ooqlXG1zApy64UPe+Ro00LHLmfPw=";
      "aarch64-linux" = "sha256-4KDGJsgpdlYODae9B3/ZwabEFycZMMlrzIpm2uXtN4M=";
      "x86_64-linux" = "sha256-/ZJDM++ftULETeYBS8tKIhnc+kojenqrHacM+D3Vl4Y=";
    };
    platformMap = {
