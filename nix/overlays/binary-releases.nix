...
in {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    version = "2.1.110";
    hashes = {
      "aarch64-darwin" = "sha256-9FyxsHZfn8WS021xU/bB/w7Pw66cvJl+r/KwzSW/+fY=";
      "x86_64-darwin" = "sha256-1Ilid5IMJTwr2l4K4Co+OUhvogNgPCslzCNlM9aFGP0=";
      "aarch64-linux" = "sha256-/1vwNy0XAM+00jICHG4NQXIFwWOSSS2g+rxrUJ7u6So=";
      "x86_64-linux" = "sha256-fs3eV7AC1ZJ+cE3LzgTqr7kjZE0xUlm6LmrG8HEhY6Q=";
    };
    platformMap = {
