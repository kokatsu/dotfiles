...
in {
  ...
  mise = mkBinaryRelease rec {
    ...
    version = "2026.9.11";
    hashes = {
      "aarch64-darwin" = "sha256-u/1H72XCJ4xOm6CbUjvrEBk2WjwLnJ/GD2htwW81jg8=";
      "aarch64-linux" = "sha256-tJ/6+ZwK5ts2pZnvmP+zEtTcbW38ei5OFK4hIpkZ9rc=";
      "x86_64-linux" = "sha256-hligBrboAgbNSh9vstAryqMhDi0GqVxbTDEj8lAakEQ=";
    };
    platformMap = {
  ...
  claude-code = mkBinaryRelease rec {
    ...
    hashSource = "manifest";
    hashes = {
      "aarch64-darwin" = "sha256-/P2DcQOWXGTeNKa5uUNw13o0fqcYGXFaJ9Xw7wF3XqQ=";
      "aarch64-linux" = "sha256-Z2T/w56f7UJaST/2HqKFBtG6g5ls6BpI0Rd9uzk0Gck=";
      "x86_64-linux" = "sha256-Ov6FNcDMM/DiT3sl2rehcnuLWSGW+Elqi8MCuiFh7tM=";
    };
    platformMap = {
