# Custom overlays for fixing build issues
{
  ...
  claude-code = _final: prev: let
    version = "2.1.37";
    hashes = {
      "aarch64-darwin" = "sha256-AO0Qr7elYkQHc94xKEVozpwzOF1506kSoSryYq79Ew4==";
      "x86_64-darwin" = "sha256-Wtljm/NK/6RwZvuY8tetew8jYAl0TTCQd7GU2Jb8AR0==";
      "aarch64-linux" = "sha256-1yXMcwYPQAp6wDp2mWk5fa7J1BHb1bHHux+mBCe/ZX4==";
      "x86_64-linux" = "sha256-+Wek0G4WoyQ2tjKeLb7UWan6TTTwdjWh+ycbdPcGyR8==";
    };
    platformMap = {
