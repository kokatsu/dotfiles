# Custom overlays for fixing build issues
{
  ...
  claude-code = _final: prev: let
    version = "2.1.47";
    hashes = {
      "aarch64-darwin" = "sha256-c3lebY8KpOB9jyDTUeD4TlFdss5ztpdwZQvD1dWC73M=";
      "x86_64-darwin" = "sha256-tiiJsNTR8Hv3br6JttGxuFaQl3qTkwe8iWzXZ0jfMDE=";
      "aarch64-linux" = "sha256-klXTMNsZNT1zs5dbC8Lrrd0c8AKmL6Fblaa7/sipvhg=";
      "x86_64-linux" = "sha256-nEi95nvaJ01lw9ZdpPeOIaRYznIqiVXtzCctMsmMdKM=";
    };
    platformMap = {
  ...
  in {
    agent-browser = prev.buildNpmPackage {
      ...
      src = prev.fetchurl {
        ...
        hash = "sha256-9FTQHcu1XdSGB//cLQBOm+LpXPo3jJx6HV1vUoQAZkI=";
      };

      npmDepsHash = "sha256-ffsQ4hERji28j2A+NILd3NhMGXP+FuEQyuV4imRc1KE=";
      dontNpmBuild = true;
