# Custom overlays for fixing build issues
{
  ...
  claude-code = _final: prev: let
    version = "2.1.38";
    hashes = {
      "aarch64-darwin" = "sha256-cyaw0y+a2GN6Krl/206FN3fP+sTWOqWRCEQXdHlb6NA==";
      "x86_64-darwin" = "sha256-ypRE3264kaeZ0ixmbWBT+q8h/PTLogtI9oF5HwhOYlA==";
      "aarch64-linux" = "sha256-6dUUEC+EuIWNUMmLqyE5Oi2WrEiVQ7cr7/Dlj9YJGSo==";
      "x86_64-linux" = "sha256-eFj5CSK/Y9M4V7Y+BU4IpvyhlAc5U9iNUNYh+cuuAGk==";
    };
    platformMap = {
