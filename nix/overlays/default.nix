# Custom overlays for fixing build issues
{
  ...
  claude-code = _final: prev: let
    version = "2.1.45";
    hashes = {
      "aarch64-darwin" = "sha256-5lrxa5tzLOAdZCPCgffmolW1u4hQeAvs+ZkVM4bjf9Q=";
      "x86_64-darwin" = "sha256-0Q0C5rza58yNUaCDy36TM+eS027XPJSWA175VbOUtrk=";
      "aarch64-linux" = "sha256-5njw6BEuRwqScjrWiD7LGUDRQRVI9njyHqTpzEEFfn8=";
      "x86_64-linux" = "sha256-5+hHODxGZplHB3Qejlar+E3SQwFTYg07pf9ahJN15N4=";
    };
    platformMap = {
