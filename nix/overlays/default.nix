# Custom overlays for fixing build issues
{
  ...
  claude-code = _final: prev: let
    ...
    hashes = {
      ...
      "x86_64-darwin" = "sha256-viZrOpUvSD2DWK0UHir+ZhFwOGUG9Hnq2ZIxnk/cOKw==";
      "aarch64-linux" = "sha256-jEthskynYNb3qi8ZcnFj0SLp/Qw86R8QaiG2kYp7G7s==";
      "x86_64-linux" = "sha256-Tiocc4cezzsTM3a1fe0DMzp6Y4fy0qOmJ5u5Cgf3qUQ==";
    };
    platformMap = {
  ...
  in {
    agent-browser = prev.buildNpmPackage {
      ...
      src = prev.fetchurl {
        ...
        hash = "sha256-nuzmNvZFfjM+eyHk3tqrNzOwHYuqRW7YbdKTM1ph+bI=";
      };

      npmDepsHash = "sha256-AFnINvtzL+KnFHH/3kMB7N8rQLgKxDDHWQjpH9L/DBg=";
      dontNpmBuild = true;
