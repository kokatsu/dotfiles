# Custom overlays for fixing build issues
{
  ...
  claude-code = _final: prev: let
    version = "2.1.32";
    hashes = {
      "aarch64-darwin" = "sha256-hBrDBRwESApWUbyfSuJ6udOWNHclDnGJLk1uBXeN2dM==";
      "x86_64-darwin" = "sha256-K4pXvlZAB24X0j5H6SiPLR+u5lZPTjEbX3Eyv95z/e0==";
      "aarch64-linux" = "sha256-b4OQwP3luAL/d3q1QiUjP2FZ12kTrcO4rqfId0+o/nA==";
      "x86_64-linux" = "sha256-ls0bp5Z3JIG9Sb1n47hIRWXR86mWYlZVFsO/4W2a/Uo==";
    };
    platformMap = {
  ...
  in {
    agent-browser = prev.buildNpmPackage {
      ...
      src = prev.fetchurl {
        ...
        hash = "sha256-xCPc8MIKUj/ninwI+Y6Qo/+9LIxnmsvVVr6FC7AawLM=";
      };

      npmDepsHash = "sha256-PPm3PZSVxU+IafsDRfym0cNr3ujeU/V5emEy0I6NO9Q=";
      dontNpmBuild = true;
  ...
  in {
    playwright-cli = prev.buildNpmPackage {
      ...
      npmDepsHash = "sha256-40PCVzaF9aHGIUtlburUvrxvEcp0KeG9rC8IDP8aKMY=";
