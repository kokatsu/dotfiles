...
sh_files := ".codex/hooks/*.sh .config/claude/file-suggestion.sh .config/claude/hooks/*.sh .config/tmux/scripts/*.sh scripts/test-hash-patterns.sh scripts/sync-flake-inputs.sh"
