-- copilot-language-server configuration for sidekick.nvim
-- https://github.com/folke/sidekick.nvim
-- Inherits from nvim-lspconfig: https://github.com/neovim/nvim-lspconfig/blob/master/lsp/copilot.lua
