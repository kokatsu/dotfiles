---
description: Apply the user's inline notes in plan.md (spec workflow — annotate phase)
allowed-tools:
  - Read
  - Edit
  - Write
...
- Remove the markers after applying feedback.
- Leave ambiguous annotations in place and ask for clarification.
