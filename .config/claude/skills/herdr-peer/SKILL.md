...
Explicit user instructions take precedence over workflow defaults. Existing authorization to fix the current task remains valid; do not ask again for each confirmed in-scope fix.
